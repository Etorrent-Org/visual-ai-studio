...
def polish_widget_tree(
    ...
    for button in root.findChildren(
        QPushButton
    ):
        button.setCursor(
            QCursor(
    ...
    for combo in root.findChildren(
        QComboBox
    ):
    ...
    for field in root.findChildren(
        QLineEdit
    ):
        field.setMinimumHeight(36)

    for spin in root.findChildren(
        QSpinBox
    ):
    ...
    for editor in root.findChildren(
        QTextEdit
    ):
    ...
    for table in root.findChildren(
        QTableWidget
    ):
    ...
    for scroll in root.findChildren(
        QScrollArea
    ):
